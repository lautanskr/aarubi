...
<!-- Mirrored from radiustheme.com/demo/html/roofit/single-project1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Sep 2022 08:30:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Roofit | Single Project 1</title>
...
<body class="sticky-header">
    ...
    <div id="wrapper" class="wrapper">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end">
                            <div class="header-topbar-layout1">
                                <ul class="header-top-right">
                                    <li><i class="fas fa-phone-volume"></i>+880-96-100</li>
        ...
        <section class="single-project-wrap-layout1">
            <div class="container">
                <div class="single-project-box-layout1">
                    <div class="row">
                        <div class="col-xl-8 col-12">
                            <div class="single-project-slider">
                                <div class="rc-carousel nav-control-layout3" data-loop="true" data-items="10" data-margin="10"
                                ...
                                data-r-extra-large-dots="false">
                                    <div class="slide-item">
                                        <img src="img/project/project28.jpg" alt="project">
                                    </div>
                                    <div class="slide-item">
                                        <img src="img/project/project28.jpg" alt="project">
                                    </div>
                    ...
                    <div class="single-project-info">
                        <div class="item-content">
                            ...
                            <p>Ahen an unknown printer took a galley of type and scrambled it to make a type specimen book. 
                                It has survived not only five centuries, but also the leap into electronic typesetting, 
                                remaining essentially unchanged. It was popularised in the 1960s with the release of 
                                Letraset sheets containing Lorem Ipsum passages, and more recently with desktop 
                                publishing software like Aldus PageMaker including versionsAhen an unknown printer 
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="item-content">
                                    ...
                                    <p>Ahen an unknown printer took a galley of type and scrambled it to make a type 
                                    specimen book. It has survived not only five centuries.</p>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="info-img">
                                    <img src="img/project/project29.jpg" alt="project">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="item-content">
                            ...
                            <div class="col-lg-5">
                                <div class="info-img">
                                    <img src="img/project/project30.jpg" alt="project">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-box-layout1">
                                <div class="footer-logo">
                                    <a href="index-2.html"><img src="img/logo-light.png" alt="logo"></a>
                                </div>
...
<!-- Mirrored from radiustheme.com/demo/html/roofit/single-project1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Sep 2022 08:30:56 GMT -->
</html>